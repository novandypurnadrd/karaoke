...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"tb_tugas","varname"=>"tb_tugas");
	  $this->lstTables[]=array("name"=>"tb_ta","varname"=>"tb_ta");
	  $this->lstTables[]=array("name"=>"tb_sumbangan","varname"=>"tb_sumbangan");
	  $this->lstTables[]=array("name"=>"tb_reportpihak3","varname"=>"tb_reportpihak3");
	  $this->lstTables[]=array("name"=>"tb_report","varname"=>"tb_report");
	  $this->lstTables[]=array("name"=>"tb_medical","varname"=>"tb_medical");
	  $this->lstTables[]=array("name"=>"tb_meal","varname"=>"tb_meal");
	  $this->lstTables[]=array("name"=>"tb_pihakketiga","varname"=>"tb_pihakketiga");
	  $this->lstTables[]=array("name"=>"tb_piltugas","varname"=>"tb_piltugas");
	  $this->lstTables[]=array("name"=>"tb_nilaita","varname"=>"tb_nilaita");
	  $this->lstTables[]=array("name"=>"tb_pildukacita","varname"=>"tb_pildukacita");
	  $this->lstTables[]=array("name"=>"tb_pilihan","varname"=>"tb_pilihan");
	  $this->lstTables[]=array("name"=>"tb_area","varname"=>"tb_area");
	}
