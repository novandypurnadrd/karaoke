...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="tb_tugas" && $field=="tglbayar") 
	{
		return Now();
	}
				if($table=="tb_ta" && $field=="tglpay") 
	{
		return Now();
	}
				if($table=="tb_sumbangan" && $field=="tglpay") 
	{
		return Now();
	}
				if($table=="tb_medical" && $field=="tglbayar") 
	{
		return Now();
	}
				if($table=="tb_meal" && $field=="tglpay") 
	{
		return Now();
	}
				if($table=="tb_pihakketiga" && $field=="tglbayar") 
	{
		return Now();
	}
	return "";
