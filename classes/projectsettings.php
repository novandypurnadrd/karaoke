...
function GetTableURL($table = "")
{
	...
	if("tb_ta" == $table) 
		return "tb_ta";
	if("tb_sumbangan" == $table) 
		return "tb_sumbangan";
	if("tb_reportpihak3" == $table) 
		return "tb_reportpihak3";
	if("tb_report" == $table) 
		return "tb_report";
	if("tb_medical" == $table) 
		return "tb_medical";
	if("tb_meal" == $table) 
		return "tb_meal";
	if("tb_pihakketiga" == $table) 
		return "tb_pihakketiga";
	if("tb_piltugas" == $table) 
		return "tb_piltugas";
	if("tb_nilaita" == $table) 
		return "tb_nilaita";
}
...
{	
	...
	if(!$shortTName)
		return false;
	if("tb_tugas" == $shortTName) 
		return "tb_tugas";
	if("tb_ta" == $shortTName) 
		return "tb_ta";
	if("tb_sumbangan" == $shortTName) 
		return "tb_sumbangan";
	if("tb_reportpihak3" == $shortTName) 
		return "tb_reportpihak3";
	if("tb_report" == $shortTName) 
		return "tb_report";
	if("tb_medical" == $shortTName) 
		return "tb_medical";
	if("tb_meal" == $shortTName) 
		return "tb_meal";
	if("tb_pihakketiga" == $shortTName) 
		return "tb_pihakketiga";
	if("tb_piltugas" == $shortTName) 
		return "tb_piltugas";
	if("tb_nilaita" == $shortTName) 
		return "tb_nilaita";
}
