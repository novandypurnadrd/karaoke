...
$layout->blocks["top"][] = "details";$page_layouts["tb_meal_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tb_meal_edit.php?".$editlink."'\"");
