...
$layout->blocks["top"][] = "details";$page_layouts["tb_meal_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "tb_meal_inline_add.htm";
else
	$templatefile = "tb_meal_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: tb_meal_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'tb_meal_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'tb_meal_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: tb_meal_".$pageObject->getPageType().".php");
