...
$layout->blocks["top"][] = "details";$page_layouts["tb_sumbangan_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tb_sumbangan_edit.php?".$editlink."'\"");
