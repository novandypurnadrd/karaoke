...
$layout->blocks["top"][] = "pdf";$page_layouts["tb_report_print"] = $layout;
...
$arr = array();
$arr['fName'] = "nomer";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("nomer");
$fieldsArr[] = $arr;
...
//	nomer - 
			$record["nomer_value"] = $pageObject->showDBValue("nomer", $data, $keylink);
			$record["nomer_class"] = $pageObject->fieldClass("nomer");
			if($col<$colsonpage)
...
$xt->assign("nomer_fieldheadercolumn",true);
$xt->assign("nomer_fieldheader",true);
$xt->assign("nomer_fieldcolumn",true);
$xt->assign("nomer_fieldfootercolumn",true);
