...
$layout->blocks["top"][] = "details";$page_layouts["tb_tugas_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tb_tugas_edit.php?".$editlink."'\"");
