...
$layout->blocks["top"][] = "details";$page_layouts["tb_medical_view"] = $layout;
...
if (!sizeof($data)) {
	header("Location: tb_medical_list.php?a=return");
	exit();
}
...
$arr = array();
$arr['fName'] = "payfor";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("payfor");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "namapayfor";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("namapayfor");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "amount";
...
//payfor - 
	...
	if($mainTableOwnerID=="payfor")
		$ownerIdValue=$value;
	$xt->assign("payfor_value",$value);
...
//namapayfor - 
	...
	if($mainTableOwnerID=="namapayfor")
		$ownerIdValue=$value;
	$xt->assign("namapayfor_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tb_medical_edit.php?".$editlink."'\"");
