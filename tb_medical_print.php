...
$layout->blocks["top"][] = "pdf";$page_layouts["tb_medical_print"] = $layout;
...
//	dept - 
			$record["dept_value"] = $pageObject->showDBValue("dept", $data, $keylink);
			$record["dept_class"] = $pageObject->fieldClass("dept");
//	section - 
			$record["section_value"] = $pageObject->showDBValue("section", $data, $keylink);
			$record["section_class"] = $pageObject->fieldClass("section");
//	posisi - 
			$record["posisi_value"] = $pageObject->showDBValue("posisi", $data, $keylink);
			$record["posisi_class"] = $pageObject->fieldClass("posisi");
//	payfor - 
			$record["payfor_value"] = $pageObject->showDBValue("payfor", $data, $keylink);
			$record["payfor_class"] = $pageObject->fieldClass("payfor");
//	amount - Number
			$record["amount_value"] = $pageObject->showDBValue("amount", $data, $keylink);
			$record["amount_class"] = $pageObject->fieldClass("amount");
//	tglbayar - Short Date
			$record["tglbayar_value"] = $pageObject->showDBValue("tglbayar", $data, $keylink);
			$record["tglbayar_class"] = $pageObject->fieldClass("tglbayar");
//	referensi - 
			$record["referensi_value"] = $pageObject->showDBValue("referensi", $data, $keylink);
			$record["referensi_class"] = $pageObject->fieldClass("referensi");
//	nama - 
			$record["nama_value"] = $pageObject->showDBValue("nama", $data, $keylink);
			$record["nama_class"] = $pageObject->fieldClass("nama");
//	namapayfor - 
			$record["namapayfor_value"] = $pageObject->showDBValue("namapayfor", $data, $keylink);
			$record["namapayfor_class"] = $pageObject->fieldClass("namapayfor");
			if($col<$colsonpage)
...
$xt->assign("posisi_fieldheadercolumn",true);
$xt->assign("posisi_fieldheader",true);
$xt->assign("posisi_fieldcolumn",true);
$xt->assign("posisi_fieldfootercolumn",true);
$xt->assign("payfor_fieldheadercolumn",true);
$xt->assign("payfor_fieldheader",true);
$xt->assign("payfor_fieldcolumn",true);
$xt->assign("payfor_fieldfootercolumn",true);
...
$xt->assign("tglbayar_fieldheadercolumn",true);
$xt->assign("tglbayar_fieldheader",true);
$xt->assign("tglbayar_fieldcolumn",true);
$xt->assign("tglbayar_fieldfootercolumn",true);
$xt->assign("referensi_fieldheadercolumn",true);
$xt->assign("referensi_fieldheader",true);
$xt->assign("referensi_fieldcolumn",true);
$xt->assign("referensi_fieldfootercolumn",true);
...
$xt->assign("namapayfor_fieldheadercolumn",true);
$xt->assign("namapayfor_fieldheader",true);
$xt->assign("namapayfor_fieldcolumn",true);
$xt->assign("namapayfor_fieldfootercolumn",true);
