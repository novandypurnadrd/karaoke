...
$layout = new TLayout("report6","BoldWhite_label","MobileWhite_label");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["tb_pihakketiga_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="tb_pihakketiga_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "tb_pihakketiga_Report";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='tb_pihakketiga_Report_search.php';return false;\"");
